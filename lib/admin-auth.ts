 ...
 *
 * This separate password login controls Publications, Blog and Events. The
 * membership approval portal uses one-time email codes instead.
 *
...
export async function startSession() {
  ...
  (await cookies()).set(COOKIE, makeToken(secret), {
    httpOnly: true,
